...
from config import CUSTOM_TEMPLATES_DIRECTORY, CUSTOM_NEW_TEMPLATES_DIRECTORY
...
elif CUSTOM_NEW_TEMPLATES_DIRECTORY:
    # User's new templates have priority over default templates
    template_directories.insert(1, CUSTOM_NEW_TEMPLATES_DIRECTORY)
