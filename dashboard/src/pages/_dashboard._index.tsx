...
const Dashboard = () => {
  ...
  const systemStatsParams =
    is_sudo && selectedAdmin && selectedAdmin.username && currentAdmin?.username && selectedAdmin.username !== currentAdmin.username ? { admin_username: selectedAdmin.username } : undefined
