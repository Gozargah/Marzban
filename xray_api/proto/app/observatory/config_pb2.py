...
ObservationResult = _reflection.GeneratedProtocolMessageType(
    "ObservationResult",
    (_message.Message,),
    {
...
HealthPingMeasurementResult = _reflection.GeneratedProtocolMessageType(
    "HealthPingMeasurementResult",
    (_message.Message,),
    {
...
OutboundStatus = _reflection.GeneratedProtocolMessageType(
    "OutboundStatus",
    (_message.Message,),
    {
...
ProbeResult = _reflection.GeneratedProtocolMessageType(
    "ProbeResult",
    (_message.Message,),
    {
