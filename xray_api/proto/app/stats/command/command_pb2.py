...
GetStatsRequest = _reflection.GeneratedProtocolMessageType(
    "GetStatsRequest",
    (_message.Message,),
    {
...
GetStatsResponse = _reflection.GeneratedProtocolMessageType(
    "GetStatsResponse",
    (_message.Message,),
    {
...
QueryStatsRequest = _reflection.GeneratedProtocolMessageType(
    "QueryStatsRequest",
    (_message.Message,),
    {
...
QueryStatsResponse = _reflection.GeneratedProtocolMessageType(
    "QueryStatsResponse",
    (_message.Message,),
    {
...
SysStatsRequest = _reflection.GeneratedProtocolMessageType(
    "SysStatsRequest",
    (_message.Message,),
    {
...
SysStatsResponse = _reflection.GeneratedProtocolMessageType(
    "SysStatsResponse",
    (_message.Message,),
    {
