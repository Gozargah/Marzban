                                            ...
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input placeholder={t('templates.name')}
                                                           isError={!!form.formState.errors.name} {...field}
                                ...
                                <FormField
                                    ...
                                    render={({field}) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input type="text" placeholder={t('templates.prefix')} {...field}
                                ...
                                <FormField
                                    ...
                                    render={({field}) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input type="text" placeholder={t('templates.suffix')} {...field}
                                                       onChange={e => field.onChange(e.target.value)}/>
                                            </FormControl>
                                            <FormMessage/>
                                        </FormItem>
                                ...
                                {groupsLoading ? (
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => {
                                            ...
                                            const allSelected = filteredGroups.length > 0 && filteredGroups.every((group: any) => selectedGroups.includes(group.id))
                                                        ...
                                                        <div
                                                            ...
                                                            {filteredGroups.length === 0 ? (
                                                                <div
                                                                    ...
                                                                    <span
                                                                        className="text-sm ftext-foreground font-bold text-yellow-500">{t('warning')}</span>
                                                                    <span
