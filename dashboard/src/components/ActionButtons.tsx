...
import { Check, Copy, Pencil, User, QrCode, RefreshCcw, PieChart, Trash2, EllipsisVertical, ListStart } from 'lucide-react'
    ...
    <div onClick={e => e.stopPropagation()}>
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent dir={dir}>
          <AlertDialogHeader>
            <AlertDialogTitle className={cn(dir === 'rtl' && 'sm:text-right')}>{t('usersTable.deleteUserTitle')}</AlertDialogTitle>
            <AlertDialogDescription className={cn(dir === 'rtl' && 'sm:text-right')}>{t('usersTable.deleteUserPrompt', { name: user.username })}</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter className={cn('flex flex-col-reverse gap-2 sm:flex-row sm:justify-end sm:gap-0 sm:space-x-2', dir === 'rtl' && 'sm:flex-row-reverse sm:space-x-reverse')}>
      ...
      <AlertDialog open={isResetUsageDialogOpen} onOpenChange={setResetUsageDialogOpen}>
        <AlertDialogContent dir={dir}>
          <AlertDialogHeader>
            <AlertDialogTitle className={cn(dir === 'rtl' && 'sm:text-right')}>{t('usersTable.resetUsageTitle')}</AlertDialogTitle>
            <AlertDialogDescription className={cn(dir === 'rtl' && 'sm:text-right')}>{t('usersTable.resetUsagePrompt', { name: user.username })}</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter className={cn('flex flex-col-reverse gap-2 sm:flex-row sm:justify-end sm:gap-0 sm:space-x-2', dir === 'rtl' && 'sm:flex-row-reverse sm:space-x-reverse')}>
      ...
      <AlertDialog open={isRevokeSubDialogOpen} onOpenChange={setRevokeSubDialogOpen}>
        <AlertDialogContent dir={dir}>
          <AlertDialogHeader>
            <AlertDialogTitle className={cn(dir === 'rtl' && 'sm:text-right')}>{t('revokeUserSub.title')}</AlertDialogTitle>
            <AlertDialogDescription className={cn(dir === 'rtl' && 'sm:text-right')}>{t('revokeUserSub.prompt', { username: user.username })}</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter className={cn('flex flex-col-reverse gap-2 sm:flex-row sm:justify-end sm:gap-0 sm:space-x-2', dir === 'rtl' && 'sm:flex-row-reverse sm:space-x-reverse')}>
