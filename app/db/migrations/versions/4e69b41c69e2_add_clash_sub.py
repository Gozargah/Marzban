...
def upgrade() -> None:
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.add_column(sa.Column('sub_tags', sa.String(length=256, collation='NOCASE'), nullable=True))
        batch_op.add_column(sa.Column('sub_url_prefix', sa.String(length=64, collation='NOCASE'), nullable=True))
        batch_op.create_index(batch_op.f('ix_users_sub_tags'), ['sub_tags'], unique=False)
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_users_sub_tags'))
        batch_op.drop_column('sub_url_prefix')
        batch_op.drop_column('sub_tags')
