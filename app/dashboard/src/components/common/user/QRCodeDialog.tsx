...
import { ChevronLeftIcon, ChevronRightIcon, QrCodeIcon } from "@heroicons/react/24/outline";
            ...
            <Box w="300px">
              ...
              >
                {QRcodeLinks.map((link, i) => {
                  return (
                    <HStack key={i}>
                      <QRCode mx="auto" size={300} p="2" level={"L"} includeMargin={false} value={link} bg="white" />
                    </HStack>
                  );
                })}
              </Slider>
