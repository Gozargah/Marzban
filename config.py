...
XRAY_SUBSCRIPTION_PATH = config("XRAY_SUBSCRIPTION_PATH", default="/sub/")

if not XRAY_SUBSCRIPTION_PATH.startswith("/"):
    XRAY_SUBSCRIPTION_PATH = f"/{XRAY_SUBSCRIPTION_PATH}"
if not XRAY_SUBSCRIPTION_PATH.endswith("/"):
    XRAY_SUBSCRIPTION_PATH = f"{XRAY_SUBSCRIPTION_PATH}/"
