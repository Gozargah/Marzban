    ...
    try {
      ...
      form.reset()
        ...
        if (error?.response?._data && !isEmptyObject(error?.response?._data)) {
            ...
            if (error?.response?._data?.detail) {
                ...
                if (typeof detail === 'object' && detail !== null && !Array.isArray(detail)) {
                                ...
                                message:
                                    typeof message === 'string'
                                        ...
                                        : t('validation.invalid', {
                                            field: t(`adminDialog.${field}`, { defaultValue: field }),
                    ...
                    toast.error(
                        firstMessage ||
                        t('validation.invalid', {
                            field: t(`adminDialog.${firstField}`, { defaultValue: firstField }),
            ...
            toast.error(error?.message || t('admins.genericError', { defaultValue: 'An error occurred' }))
        }
    }
  }
                        ...
                        <FormItem className="min-h-[100px]">
                          ...
                          <FormControl>
                            <div className="relative">
                              <Input type={showPassword ? 'text' : 'password'} placeholder={t('admins.enterPassword')} isError={hasError} {...field} />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="min-h-[100px]">
                        ...
                        <FormControl>
                          <div className="relative">
                            <Input type={showPasswordConfirm ? 'text' : 'password'} placeholder={t('admins.enterPasswordConfirm')} {...field} />
                            <Button
                              type="button"
                              variant="ghost"
                              size="sm"
