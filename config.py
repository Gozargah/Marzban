...
XRAY_SOCKS_INBOUND_TAG = config("XRAY_SOCKS_INBOUND_TAG", default="SOCKS5_INBOUND").strip()
...
MTPROTO_NODE_NAME = config("MTPROTO_NODE_NAME", default="").strip()
MTPROTO_PUBLIC_HOST = config("MTPROTO_PUBLIC_HOST", default="").strip()
MTPROTO_PUBLIC_PORT = config("MTPROTO_PUBLIC_PORT", cast=int, default=1443)
