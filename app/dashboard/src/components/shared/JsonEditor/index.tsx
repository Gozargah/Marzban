...
import "./styles.css";
import { installTheme } from "./themes";
...
export const JsonEditor = forwardRef<HTMLDivElement, JSONEditorProps>(({ json, onChange, mode = "code" }, ref) => {
  ...
  useEffect(() => {
    jsonEditorRef.current = new JSONEditor(jsonEditorContainer.current!, options);
    installTheme();
    return () => {
