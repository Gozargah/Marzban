...
export const getAdminTokenMutationOptions = <TError = ErrorType<Unauthorized | HTTPValidationError>, TContext = unknown>(options?: {
 ...
 * @summary Admin Token
 */
export const useAdminToken = <TError = ErrorType<Unauthorized | HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof adminToken>>, TError, { data: BodyType<BodyAdminTokenApiAdminTokenPost> }, TContext>
...
export const getModifyAdminMutationOptions = <TError = ErrorType<Unauthorized | Forbidden | HTTPValidationError>, TContext = unknown>(options?: {
 ...
 * @summary Modify Admin
 */
export const useModifyAdmin = <TError = ErrorType<Unauthorized | Forbidden | HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof modifyAdmin>>, TError, { username: string; data: BodyType<AdminModify> }, TContext>
...
export const getResetAdminUsageMutationOptions = <TError = ErrorType<Unauthorized | Forbidden | HTTPValidationError>, TContext = unknown>(options?: {
 ...
 * @summary Reset Admin Usage
 */
export const useResetAdminUsage = <TError = ErrorType<Unauthorized | Forbidden | HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof resetAdminUsage>>, TError, { username: string }, TContext>
...
export function useGetAdminUsage<TData = Awaited<ReturnType<typeof getAdminUsage>>, TError = ErrorType<Unauthorized | Forbidden | HTTPValidationError>>(
  ...
  options: {
    query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getAdminUsage>>, TError, TData>> &
      Pick<DefinedInitialDataOptions<Awaited<ReturnType<typeof getAdminUsage>>, TError, Awaited<ReturnType<typeof getAdminUsage>>>, 'initialData'>
  },
): DefinedUseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
export function useGetAdminUsage<TData = Awaited<ReturnType<typeof getAdminUsage>>, TError = ErrorType<Unauthorized | Forbidden | HTTPValidationError>>(
  username: string,
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getAdminUsage>>, TError, TData>> &
      Pick<UndefinedInitialDataOptions<Awaited<ReturnType<typeof getAdminUsage>>, TError, Awaited<ReturnType<typeof getAdminUsage>>>, 'initialData'>
  },
): UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
export function useGetAdminUsage<TData = Awaited<ReturnType<typeof getAdminUsage>>, TError = ErrorType<Unauthorized | Forbidden | HTTPValidationError>>(
  username: string,
...
export function useGetCoreStats<TData = Awaited<ReturnType<typeof getCoreStats>>, TError = ErrorType<Unauthorized>>(options: {
  query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getCoreStats>>, TError, TData>> &
    Pick<DefinedInitialDataOptions<Awaited<ReturnType<typeof getCoreStats>>, TError, Awaited<ReturnType<typeof getCoreStats>>>, 'initialData'>
}): DefinedUseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
export function useGetCoreStats<TData = Awaited<ReturnType<typeof getCoreStats>>, TError = ErrorType<Unauthorized>>(options?: {
  query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getCoreStats>>, TError, TData>> &
    Pick<UndefinedInitialDataOptions<Awaited<ReturnType<typeof getCoreStats>>, TError, Awaited<ReturnType<typeof getCoreStats>>>, 'initialData'>
}): UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
export function useGetCoreStats<TData = Awaited<ReturnType<typeof getCoreStats>>, TError = ErrorType<Unauthorized>>(options?: {
  query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getCoreStats>>, TError, TData>>
}): UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export const getRestartCoreMutationOptions = <TError = ErrorType<Unauthorized | Forbidden>, TContext = unknown>(options?: {
 ...
 * @summary Restart Core
 */
export const useRestartCore = <TError = ErrorType<Unauthorized | Forbidden>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof restartCore>>, TError, void, TContext>
}): UseMutationResult<Awaited<ReturnType<typeof restartCore>>, TError, void, TContext> => {
...
export const getModifyCoreConfigMutationOptions = <TError = ErrorType<Unauthorized | Forbidden | HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof modifyCoreConfig>>, TError, { data: BodyType<ModifyCoreConfigBody> }, TContext>
}): UseMutationOptions<Awaited<ReturnType<typeof modifyCoreConfig>>, TError, { data: BodyType<ModifyCoreConfigBody> }, TContext> => {
...
export const useModifyCoreConfig = <TError = ErrorType<Unauthorized | Forbidden | HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof modifyCoreConfig>>, TError, { data: BodyType<ModifyCoreConfigBody> }, TContext>
}): UseMutationResult<Awaited<ReturnType<typeof modifyCoreConfig>>, TError, { data: BodyType<ModifyCoreConfigBody> }, TContext> => {
...
export const getAddHostMutationOptions = <TError = ErrorType<Unauthorized | Forbidden | HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof addHost>>, TError, { data: BodyType<CreateHost> }, TContext>
}): UseMutationOptions<Awaited<ReturnType<typeof addHost>>, TError, { data: BodyType<CreateHost> }, TContext> => {
 ...
 * @summary Add Host
 */
export const useAddHost = <TError = ErrorType<Unauthorized | Forbidden | HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof addHost>>, TError, { data: BodyType<CreateHost> }, TContext>
}): UseMutationResult<Awaited<ReturnType<typeof addHost>>, TError, { data: BodyType<CreateHost> }, TContext> => {
...
export const getModifyHostMutationOptions = <TError = ErrorType<Unauthorized | Forbidden | NotFound | HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof modifyHost>>, TError, { hostId: number; data: BodyType<HostResponse> }, TContext>
}): UseMutationOptions<Awaited<ReturnType<typeof modifyHost>>, TError, { hostId: number; data: BodyType<HostResponse> }, TContext> => {
...
export const useModifyHost = <TError = ErrorType<Unauthorized | Forbidden | NotFound | HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof modifyHost>>, TError, { hostId: number; data: BodyType<HostResponse> }, TContext>
}): UseMutationResult<Awaited<ReturnType<typeof modifyHost>>, TError, { hostId: number; data: BodyType<HostResponse> }, TContext> => {
...
export const getModifyHostsMutationOptions = <TError = ErrorType<Unauthorized | Forbidden | HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof modifyHosts>>, TError, { data: BodyType<HostResponse[]> }, TContext>
}): UseMutationOptions<Awaited<ReturnType<typeof modifyHosts>>, TError, { data: BodyType<HostResponse[]> }, TContext> => {
...
export const useModifyHosts = <TError = ErrorType<Unauthorized | Forbidden | HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof modifyHosts>>, TError, { data: BodyType<HostResponse[]> }, TContext>
}): UseMutationResult<Awaited<ReturnType<typeof modifyHosts>>, TError, { data: BodyType<HostResponse[]> }, TContext> => {
...
export const getAddNodeMutationOptions = <TError = ErrorType<Unauthorized | Forbidden | Conflict | HTTPValidationError>, TContext = unknown>(options?: {
 ...
 * @summary Add Node
 */
export const useAddNode = <TError = ErrorType<Unauthorized | Forbidden | Conflict | HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof addNode>>, TError, { data: BodyType<NodeCreate> }, TContext>
}): UseMutationResult<Awaited<ReturnType<typeof addNode>>, TError, { data: BodyType<NodeCreate> }, TContext> => {
...
export const getAddUserMutationOptions = <TError = ErrorType<HTTPException | Unauthorized | Conflict | HTTPValidationError>, TContext = unknown>(options?: {
 ...
 * @summary Add User
 */
export const useAddUser = <TError = ErrorType<HTTPException | Unauthorized | Conflict | HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof addUser>>, TError, { data: BodyType<UserCreate> }, TContext>
}): UseMutationResult<Awaited<ReturnType<typeof addUser>>, TError, { data: BodyType<UserCreate> }, TContext> => {
...
export const getSetOwnerMutationOptions = <TError = ErrorType<Unauthorized | HTTPValidationError>, TContext = unknown>(options?: {
 ...
 * @summary Set Owner
 */
export const useSetOwner = <TError = ErrorType<Unauthorized | HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof setOwner>>, TError, { username: string; params: SetOwnerParams }, TContext>
...
export function useUserGetUsage<TData = Awaited<ReturnType<typeof userGetUsage>>, TError = ErrorType<HTTPValidationError>>(
  ...
  options: {
    query: Partial<UseQueryOptions<Awaited<ReturnType<typeof userGetUsage>>, TError, TData>> &
      Pick<DefinedInitialDataOptions<Awaited<ReturnType<typeof userGetUsage>>, TError, Awaited<ReturnType<typeof userGetUsage>>>, 'initialData'>
  },
): DefinedUseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
export function useUserGetUsage<TData = Awaited<ReturnType<typeof userGetUsage>>, TError = ErrorType<HTTPValidationError>>(
  token: string,
  ...
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof userGetUsage>>, TError, TData>> &
      Pick<UndefinedInitialDataOptions<Awaited<ReturnType<typeof userGetUsage>>, TError, Awaited<ReturnType<typeof userGetUsage>>>, 'initialData'>
  },
): UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
export function useUserGetUsage<TData = Awaited<ReturnType<typeof userGetUsage>>, TError = ErrorType<HTTPValidationError>>(
  token: string,
...
export const getAddUserTemplateMutationOptions = <TError = ErrorType<HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof addUserTemplate>>, TError, { data: BodyType<UserTemplateCreate> }, TContext>
}): UseMutationOptions<Awaited<ReturnType<typeof addUserTemplate>>, TError, { data: BodyType<UserTemplateCreate> }, TContext> => {
 ...
 * @summary Add User Template
 */
export const useAddUserTemplate = <TError = ErrorType<HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof addUserTemplate>>, TError, { data: BodyType<UserTemplateCreate> }, TContext>
}): UseMutationResult<Awaited<ReturnType<typeof addUserTemplate>>, TError, { data: BodyType<UserTemplateCreate> }, TContext> => {
...
export function useGetUserTemplateEndpoint<TData = Awaited<ReturnType<typeof getUserTemplateEndpoint>>, TError = ErrorType<HTTPValidationError>>(
  ...
  options: {
    query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getUserTemplateEndpoint>>, TError, TData>> &
      Pick<DefinedInitialDataOptions<Awaited<ReturnType<typeof getUserTemplateEndpoint>>, TError, Awaited<ReturnType<typeof getUserTemplateEndpoint>>>, 'initialData'>
  },
): DefinedUseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
export function useGetUserTemplateEndpoint<TData = Awaited<ReturnType<typeof getUserTemplateEndpoint>>, TError = ErrorType<HTTPValidationError>>(
  templateId: number,
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getUserTemplateEndpoint>>, TError, TData>> &
      Pick<UndefinedInitialDataOptions<Awaited<ReturnType<typeof getUserTemplateEndpoint>>, TError, Awaited<ReturnType<typeof getUserTemplateEndpoint>>>, 'initialData'>
  },
): UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
export function useGetUserTemplateEndpoint<TData = Awaited<ReturnType<typeof getUserTemplateEndpoint>>, TError = ErrorType<HTTPValidationError>>(
  templateId: number,
...
export const getModifyUserTemplateMutationOptions = <TError = ErrorType<HTTPValidationError>, TContext = unknown>(options?: {
 ...
 * @summary Modify User Template
 */
export const useModifyUserTemplate = <TError = ErrorType<HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof modifyUserTemplate>>, TError, { templateId: number; data: BodyType<UserTemplateModify> }, TContext>
...
export const getRemoveUserTemplateMutationOptions = <TError = ErrorType<HTTPValidationError>, TContext = unknown>(options?: {
 ...
 * @summary Remove User Template
 */
export const useRemoveUserTemplate = <TError = ErrorType<HTTPValidationError>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof removeUserTemplate>>, TError, { templateId: number }, TContext>
