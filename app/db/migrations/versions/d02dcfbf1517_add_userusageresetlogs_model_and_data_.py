...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('data_limit_reset_strategy', sa.Enum("no_reset", "day", "week",
                  "month", "year", name="userdatalimitresetstrategy"), nullable=False, server_default="no_reset"))
