  ...
  return (
    <Dialog open={isDialogOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-full sm:max-w-[1000px] h-full sm:h-auto px-4 py-6">
        <DialogHeader>
          <DialogTitle className={cn('text-xl text-start font-semibold', dir === 'rtl' && 'sm:text-right')}>{editingCore ? t('coreConfigModal.editCore') : t('coreConfigModal.addConfig')}</DialogTitle>
                ...
                <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                          <div>
                            ...
                            <div className="flex items-center gap-2">
                              <code className="bg-muted p-2 rounded text-sm flex-1 overflow-x-auto whitespace-nowrap">{keyPair.publicKey}</code>
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2">
                              <code className="bg-muted p-2 rounded text-sm flex-1 overflow-x-auto whitespace-nowrap">{keyPair.privateKey}</code>
                  ...
                  {generatedShortId && (
                    <div className="mt-4 p-4 border rounded-md relative">
                      ...
                      <div className="flex items-center gap-2">
                        <code className="bg-muted p-2 rounded text-sm flex-1 overflow-x-auto whitespace-nowrap">{generatedShortId}</code>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className={'flex items-center gap-2 flex-row-reverse mb-2'}>
                        ...
                        <FormLabel className="text-sm !m-0">{t('coreConfigModal.restartNodes')}</FormLabel>
                      </FormItem>
                    )}
                  />
                )}
