...
export const Filters = ({filters, onFilterChange, refetch, advanceSearchOnOpen}: FiltersProps) => {
    ...
    return (
        <div dir={dir} className="flex items-center gap-4 py-4">
            ...
            {/* Refresh Button */}
            <div className="flex items-center gap-2 h-full">
                <Button size="icon-md" onClick={handleRefreshClick} variant="ghost"
                        className="flex items-center gap-2 border" disabled={isRefreshing}>
        ...
        <div className="mt-4 flex flex-col-reverse md:flex-row gap-4 items-center justify-between">
            <div className="flex items-center gap-2">
                <Select value={itemsPerPage.toString()}
                        onValueChange={value => onItemsPerPageChange(parseInt(value, 10))} disabled={isLoading}>
