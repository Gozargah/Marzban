...
import {UserResponse, UserStatus, getUsers} from '@/service/api'
...
export default function UsersTable(){
    ...
    const handleAdvanceSearchSubmit = (values: AdvanceSearchFormValue) => {
        ...
        const statusValue = values.status && values.status.length > 0
            ? values.status[0] as UserStatus
            : undefined;
    ...
    return (
        <div>
            <Filters
                ...
                advanceSearchOnOpen={handleOpenAdvanceSearch}
            />
            <DataTable columns={columns} data={mergedUsers} isLoading={isPageLoading} isFetching={isPageLoading}
                       onEdit={handleEdit}/>
            <PaginationControls
