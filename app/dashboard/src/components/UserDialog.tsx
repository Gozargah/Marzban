...
import {ChartPieIcon, PencilIcon, UserPlusIcon,InformationCircleIcon} from "@heroicons/react/24/outline";
                        ...
                        {isEditing && isDetailsVisible && (
                            <><><FormLabel>{t("userDialog.onlineAt")}</FormLabel><Input
                              ...
                              <FormLabel style={{marginTop: '10px'}}>{t("userDialog.subUpdatedAt")}</FormLabel><Input
                                  ...
                                  type="text"
                                  borderRadius="6px"
                                  error={form.formState.errors.sub_last_user_agent?.message}
                                  disabled={true}
                  ...
                  >
                    {isEditing && (
                        <>
                          ...
                          <Tooltip label={t("userDialog.moreDetails")} placement="top">
                            <IconButton
