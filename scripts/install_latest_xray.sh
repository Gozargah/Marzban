...
update_geosite() {
    RUDAT_URL=https://raw.githubusercontent.com/runetfreedom/russia-v2ray-rules-dat/release
    curl -o "${TMP_DIRECTORY}/geoip.dat" $RUDAT_URL/geoip.dat
    curl -o "${TMP_DIRECTORY}/geosite.dat" $RUDAT_URL/geosite.dat
}
