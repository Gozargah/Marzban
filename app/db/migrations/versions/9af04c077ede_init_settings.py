...
telegram = {
    ...
    "token": config.TELEGRAM_API_TOKEN if config.TELEGRAM_API_TOKEN else None,
    "webhook_url": config.TELEGRAM_WEBHOOK_URL if config.TELEGRAM_WEBHOOK_URL else None,
    "webhook_secret": config.TELEGRAM_WEBHOOK_SECRET_KEY if config.TELEGRAM_WEBHOOK_SECRET_KEY else None,
...
notification_settings = {
    ...
    "telegram_api_token": config.TELEGRAM_API_TOKEN if config.TELEGRAM_API_TOKEN else None,
    "telegram_admin_id": config.TELEGRAM_ADMIN_ID if config.TELEGRAM_ADMIN_ID else None,
    "telegram_channel_id": config.TELEGRAM_LOGGER_CHANNEL_ID if config.TELEGRAM_LOGGER_CHANNEL_ID else None,
    "telegram_topic_id": config.TELEGRAM_LOGGER_TOPIC_ID if config.TELEGRAM_LOGGER_TOPIC_ID else None,
