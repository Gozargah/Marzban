...
def record_user_usages():
    ...
    for node_id, params in api_params.items():
        factor = consumption_coefficent.get(node_id, 1)  # get the consumption coefficent for the node
        for param in params:
            users_usage[param['uid']] += param['value'] * factor  # apply the consumption factor
