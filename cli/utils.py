...
# The older names are kept so SkyPanel and Marzban deployments keep working
PASSWORD_ENVIRON_NAME = ["XENITH_ADMIN_PASSWORD", "SKYPANEL_ADMIN_PASSWORD", "MARZBAN_ADMIN_PASSWORD"]
