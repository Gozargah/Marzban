...
def delete_expired(
    ...
    with GetDB() as db:
        ...
        all_users += crud.get_users(db, status=UserStatus.limited)
...
def change_data_limit(
    ...
    NOTE: This command allows you to increase or decrease the data limit for active users.
...
def change_expire(
    ...
    NOTE: This command allows you to increase or decrease the expiration date for active users.
